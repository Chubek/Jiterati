# Chapter 10: Backend Interface

This chapter explains target contracts, instruction selection, register allocation, rewriting, and emission. It is written for compiler engineers who already understand SSA, lowering, ABI boundaries, and pass pipelines, but who need a reliable map of Jiterati terminology and conventions.
...
- In the context of backend interface, define the boundary between generic Jiterati behavior and extension-specific behavior before adding new code.
...
- Backend Interface should be understood as part of the larger Jiterati contract, not as an isolated implementation detail.
