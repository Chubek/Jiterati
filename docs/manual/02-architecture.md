...
This chapter explains module boundaries, IR layers, passes, plugins, backends, and host integration. It is written for compiler engineers who already understand SSA, lowering, ABI boundaries, and pass pipelines, but who need a reliable map of Jiterati terminology and conventions.
...
- In the context of architecture, define the boundary between generic Jiterati behavior and extension-specific behavior before adding new code.
...
- Architecture should be understood as part of the larger Jiterati contract, not as an isolated implementation detail.
