# Chapter 15: Package System

This chapter explains Zstandard packages, manifests, install layout, verification, and upgrades. It is written for compiler engineers who already understand SSA, lowering, ABI boundaries, and pass pipelines, but who need a reliable map of Jiterati terminology and conventions.
...
- In the context of package system, define the boundary between generic Jiterati behavior and extension-specific behavior before adding new code.
...
- Package System should be understood as part of the larger Jiterati contract, not as an isolated implementation detail.
