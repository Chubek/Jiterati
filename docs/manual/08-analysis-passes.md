# Chapter 8: Analysis Passes

This chapter explains CFG, dominators, liveness, data-flow, and analysis preservation. It is written for compiler engineers who already understand SSA, lowering, ABI boundaries, and pass pipelines, but who need a reliable map of Jiterati terminology and conventions.
...
- In the context of analysis passes, define the boundary between generic Jiterati behavior and extension-specific behavior before adding new code.
...
- Analysis Passes should be understood as part of the larger Jiterati contract, not as an isolated implementation detail.
