# Chapter 9: Transformation Passes

This chapter explains constant folding, propagation, DCE, strength reduction, and peepholes. It is written for compiler engineers who already understand SSA, lowering, ABI boundaries, and pass pipelines, but who need a reliable map of Jiterati terminology and conventions.
...
- In the context of transformation passes, define the boundary between generic Jiterati behavior and extension-specific behavior before adding new code.
...
- Transformation Passes should be understood as part of the larger Jiterati contract, not as an isolated implementation detail.
