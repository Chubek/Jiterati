# Chapter 18: Internal Design

This chapter explains implementation invariants, maintenance rules, generated data, and extension points. It is written for compiler engineers who already understand SSA, lowering, ABI boundaries, and pass pipelines, but who need a reliable map of Jiterati terminology and conventions.
...
- In the context of internal design, define the boundary between generic Jiterati behavior and extension-specific behavior before adding new code.
...
- Internal Design should be understood as part of the larger Jiterati contract, not as an isolated implementation detail.
