# Chapter 14: Writing Passes

This chapter explains pass contracts, analysis invalidation, deterministic behavior, and testing. It is written for compiler engineers who already understand SSA, lowering, ABI boundaries, and pass pipelines, but who need a reliable map of Jiterati terminology and conventions.
...
- In the context of writing passes, define the boundary between generic Jiterati behavior and extension-specific behavior before adding new code.
...
- Writing Passes should be understood as part of the larger Jiterati contract, not as an isolated implementation detail.
